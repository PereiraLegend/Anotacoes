...
export default function CabecalhoAdmin() {
    ...
    return (
        <div>
            ...
            <div className="flex">
                {/**Menu Lateral */}
                <div className={`w-[140px] h-[100%] text-white text-lg bg-[#4F46E5] absolute ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className="cursor-pointer bg-[#4F46E5] hover:bg-gray-300 p-1 rounded-lg m-1" onClick={() => navegacao('/admin/dashboard')}>
                        Home
                    </div>
                    <div className="cursor-pointer bg-[#4F46E5] hover:bg-gray-300 p-1 rounded-lg m-1" onClick={() => navegacao('/admin/tags')}>
                        Tags
                    </div>
                </div>
            </div>
