    ...
    return(
            ...
            <div className="w-[100%] h-[400px] bg-gray-50 cursor-pointer">
                ...
                <div className="flex justify-center">
                    <Link href="/produto"><div className="bg-gray-400 pl-7 pr-7 pt-2 pb-2 flex items-center hover:cursor-pointer mb-14 hover:border">Comprar <FiShoppingCart /></div></Link>
                </div>
            </div>
